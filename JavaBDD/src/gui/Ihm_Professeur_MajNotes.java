...
public class Ihm_Professeur_MajNotes extends JFrame {
	...
	public Ihm_Professeur_MajNotes() {
		...
		btnConfirm.setBounds(85, 413, 130, 23);
		...
		textField_4.setBounds(8, 377, 280, 25);
		...
		lblModifierValeur.setBounds(8, 356, 142, 20);
		...
		lblValeurActuelle.setBounds(8, 304, 142, 20);
		...
		textField_3.setBounds(8, 325, 280, 25);
		...
		lblChampSelection.setBounds(8, 252, 142, 20);
		...
		textField_2.setBounds(8, 273, 280, 25);
		...
		separator_3.setBounds(8, 530, 284, 2);
		...
		btnNewButton_1.setBounds(10, 543, 282, 23);
